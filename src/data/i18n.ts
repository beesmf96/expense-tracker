...
const S = {
  en: {
    ...
    monthlyBudget: 'Monthly Budget', budgetOptional: 'Optional',
    vsMonth: 'vs', ofBudget: 'of budget',
    backup: 'Backup Data', restore: 'Restore Backup', clearAll: 'Clear All Data',
    language: 'Language', appearance: 'Appearance', darkTheme: 'Dark theme', lightTheme: 'Light theme', swipeNav: 'Swipe Navigation',
    ...
    occurrencesLabel: 'Times', occurrencesPlaceholder: 'Forever',
    recurringTabActive: 'Active', recurringTabDone: 'Done',
    noActiveRecurring: 'No active recurring expenses.', noDoneRecurring: 'No completed plans yet.',
    ...
    emojiGroup_money: 'Money', emojiGroup_food: 'Food', emojiGroup_transport: 'Travel',
    emojiGroup_home: 'Home', emojiGroup_shopping: 'Shop', emojiGroup_health: 'Health',
    emojiGroup_entertainment: 'Fun', emojiGroup_other: 'Other',
  ...
  zh: {
    ...
    monthlyBudget: '每月预算', budgetOptional: '可选',
    vsMonth: '对比', ofBudget: '预算占比',
    backup: '备份数据', restore: '恢复备份', clearAll: '清除所有数据',
    language: '语言', appearance: '外观', darkTheme: '深色', lightTheme: '浅色', swipeNav: '滑动切月',
    ...
    occurrencesLabel: '次数', occurrencesPlaceholder: '永久',
    recurringTabActive: '进行中', recurringTabDone: '已完成',
    noActiveRecurring: '暂无进行中的周期支出。', noDoneRecurring: '暂无已完成的计划。',
    ...
    emojiGroup_money: '金融', emojiGroup_food: '餐饮', emojiGroup_transport: '出行',
    emojiGroup_home: '家居', emojiGroup_shopping: '购物', emojiGroup_health: '健康',
    emojiGroup_entertainment: '娱乐', emojiGroup_other: '其他',
