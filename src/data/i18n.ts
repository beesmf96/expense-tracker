...
const S = {
  en: {
    ...
    footer: 'MyLedger', dangerZone: 'Danger Zone',
    search: 'Search', searchPlaceholder: 'Search notes or categories…', searchEmpty: 'No results',
  ...
  zh: {
    ...
    footer: 'MyLedger', dangerZone: '危险区域',
    search: '搜索', searchPlaceholder: '搜索备注或类别…', searchEmpty: '无结果',
